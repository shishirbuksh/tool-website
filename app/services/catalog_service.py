    ...
    def get_categorized_tools(self):
        ...
        category_map = {
            ...
            "crypto-fear-greed-index-tracker": (
                "AI & Crypto",
                "Track crypto market sentiment with the Fear & Greed Index. See if investors are fearful or greedy",
            ),
            ...
            "airdrop-finder": (
                "AI & Crypto",
                "Browse active and upcoming crypto airdrops with requirements and estimated values",
            ),
            "crypto-mining-calculator": (
                "AI & Crypto",
                "Estimate mining profitability based on hash rate and power consumption",
            ),
            "crypto-halving-countdown": (
                "AI & Crypto",
                "Track countdown to the next Bitcoin halving event with live timer and block progress",
            ),
            "crypto-dca-calculator": (
                "AI & Crypto",
                "Simulate Dollar Cost Average strategies for crypto. See how regular investments grow over time",
            ),
            ...
            "crypto-portfolio-analyzer": (
                "AI & Crypto",
                "Analyze your cryptocurrency holdings, cost basis, allocation weights, and ROI",
            ),
            ...
            "profit-margin-calculator": (
                "Calculators",
                "Calculate gross profit, profit margin, markup, and selling price for products and services",
            ),
            "mrr-calculator": (
                "Calculators",
                "Calculate Monthly Recurring Revenue, ARR, churn impact, and customer LTV for SaaS and subscription businesses",
            ),
            ...
            "instagram-calculator": (
                "Calculators",
                "Calculate Instagram engagement rate, reach, earnings per post, and optimal posting frequency",
            ),
            "compound-calculator": ("Calculators", "Calculate compound interest growth with monthly contributions"),
            "debt-calculator": (
                "Calculators",
                "Compare snowball and avalanche debt payoff methods and see when you'll be debt-free",
            ),
            "credit-utilization-calculator": ("Calculators", "Determine credit utilization ratio for credit cards"),
            "loan-affordability-calculator": (
                "Calculators",
                "Find out how much loan you can afford based on your income and monthly debts",
            ),
            "mortgage-overpayment-calculator": (
                "Calculators",
                "See how much interest extra mortgage payments save and how early you pay off your home loan",
            ),
            ...
            "base64-tool": ("Developer & SEO", "Encode and decode text using Base64 format instantly in your browser"),
            ...
            "keyword-data-analyzer": (
                "Developer & SEO",
                "Analyze keyword difficulty, search volume, competition level, and traffic potential",
            ),
            "meta-tag-generator": (
                "Developer & SEO",
                "Generate HTML meta tags, Open Graph tags, and Twitter cards for SEO — with live SERP preview",
            ),
            "open-graph-generator": (
                "Developer & SEO",
                "Generate Open Graph meta tags and Twitter cards for social media sharing previews",
            ),
            "job-card-generator": (
                "Business & Operations",
                "Create professional job cards and work orders for service technicians and mechanics",
            ),
            ...
            "purchase-order-generator": (
                "Business & Operations",
                "Create professional purchase orders with logo, theme, and print/PDF download",
            ),
            "sales-order-generator": (
                "Business & Operations",
                "Create professional sales orders with logo, theme, and print/PDF download",
            ),
            "service-order-generator": (
                "Business & Operations",
                "Generate professional service orders with instant cost calculation",
            ),
            "work-order-generator": (
                "Business & Operations",
                "Create instant work orders with cost breakdown for maintenance and repairs",
            ),
            "ad-performance-analyzer": (
                "Business & Operations",
                "Measure ad campaign ROAS, CTR, CPC, CPA, and conversion rates",
            ),
            "product-performance-analyzer": (
                "Business & Operations",
                "Analyze ecommerce product profit margins and break-even ROI",
            ),
            ...
            "resume-analyzer": (
                ...
                "Analyze your resume content, formatting, and ATS compatibility score",
            ),
            "resume-generator": (
                "Productivity & Utilities",
                "Build a professional, modern resume using premium templates",
            ),
            "task-manager": (
                "Productivity & Utilities",
                "Manage daily tasks with priorities, due dates, categories, and search",
            ),
            ...
            "text-case-converter": (
                "Productivity & Utilities",
                "Convert text to uppercase, lowercase, titlecase, and more",
            ),
            "unit-converter": (
                "Productivity & Utilities",
                "Convert length, mass, volume, temperature, and other units",
            ),
            ...
            "love-calculator": (
                "Productivity & Utilities",
                "Calculate love compatibility and name matching percentages online",
            ),
        }
