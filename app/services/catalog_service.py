...
class CatalogService:
    ...
    def get_categorized_tools(self):
        ...
        category_map = {
            ...
            "profit-margin-calculator": ("Calculators", "Calculate gross profit, profit margin, markup, and selling price for products and services"),
            "mrr-calculator": ("Calculators", "Calculate Monthly Recurring Revenue, ARR, churn impact, and customer LTV for SaaS and subscription businesses"),
            ...
            "mortgage-overpayment-calculator": ("Calculators", "See how much interest extra mortgage payments save and how early you pay off your home loan"),
            ...
            "keyword-data-analyzer": ("Developer & SEO", "Analyze keyword difficulty, search volume, competition level, and traffic potential"),
            "meta-tag-generator": ("Developer & SEO", "Generate HTML meta tags, Open Graph tags, and Twitter cards for SEO — with live SERP preview"),
            "open-graph-generator": ("Developer & SEO", "Generate Open Graph meta tags and Twitter cards for social media sharing previews"),
